...
public class RetrofitClient {
    ...
    private RetrofitClient(Context context) {
        ...
        this(sContext, baseUrl, null);
    }

    private RetrofitClient(Context context, String url) {

        this(sContext, url, null);
    }
    ...
    private RetrofitClient(Context context, String url, Map<String, String> headers) {
        ...
        if ( httpCacheDirectory == null) {
            httpCacheDirectory = new File(sContext.getCacheDir(), "tamic_cache");
        }
    ...
    public static void addCookie() {
        okHttpClient.newBuilder().cookieJar(new NovateCookieManger(sContext)).build();
    ...
    class DownSubscriber<ResponseBody> extends Subscriber<ResponseBody> {
        ...
        public void onNext(ResponseBody responseBody) {
            DownLoadManager.getInstance(callBack).writeResponseBodyToDisk(sContext, (okhttp3.ResponseBody) responseBody);
